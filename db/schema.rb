...
ActiveRecord::Schema.define(version: 2021_08_01_103457) do
  ...
  create_table "epg_transactions", force: :cascade do |t|
    t.bigint "user_id"
    ...
    t.string "status"
    t.integer "order_id"
    t.index ["user_id"], name: "index_epg_transactions_on_user_id"
  end

  create_table "erp_assignments", force: :cascade do |t|
    t.string "erp_number"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  create_table "orders", force: :cascade do |t|
    ...
    t.integer "order_payment_type", default: 0
    t.text "sap_errors"
